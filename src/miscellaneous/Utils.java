...
public final class Utils {
	...
	public static String getRS2String(ByteBuffer in) {
	...
	public static String getRS2String(ChannelBuffer in) {
		StringBuilder s = new StringBuilder();
		int c;
	...
	public static String getRS2String(DataInputStream in) throws IOException {
		StringBuilder s = new StringBuilder();
		int c;
		while ((c = in.readByte()) != 0) {
			s.append((char)c);
    ...
    private static final int[] anIntArray241 = {
    ...
    public static final byte[] aByteArray235 = {
